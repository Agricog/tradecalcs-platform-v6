  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Free paint calculator for UK decorators. Calculate exact paint quantities needed for walls, ceilings, and rooms. Professional tool with coverage rates." 
        />
        <meta name="keywords" content="paint calculator, decorator calculator, emulsion calculator, UK painter tools, paint coverage calculator, wall painting calculator, room painter calculator" />
