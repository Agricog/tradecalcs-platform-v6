  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Free joinery calculator for UK joiners. Calculate wood costs, labour hours, and project pricing. Professional tool for bespoke joinery and carpentry projects." 
        />
        <meta name="keywords" content="joinery calculator, wood cost calculator, carpenter calculator, UK joiner tools, timber cost calculator, bespoke joinery pricing, labour calculator" />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Joinery Calculator UK | Wood Cost & Labour Calculator" />
        <meta property="og:description" content="Calculate wood costs, labour hours, and project pricing for joinery. Free professional tool for UK joiners." />
