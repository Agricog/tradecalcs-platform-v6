...
export default function BSPThreadFinder() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <title>BSP Thread Identifier UK | British Standard Pipe Thread Size Finder</title>
      <meta name="description" content="Professional BSP thread identifier for UK plumbers. Identify British Standard Pipe threads by diameter or TPI. Complete reference tables." />
