  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Free tiling calculator for UK tilers. Calculate tiles, adhesive, and grout needed instantly. Professional tool for floor and wall tiling projects." 
        />
        <meta name="keywords" content="tiling calculator, tile calculator, UK tiler tools, grout calculator, adhesive calculator, floor tiling calculator, wall tiling calculator" />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Tiling Calculator UK | Tile & Grout Estimator for Tilers" />
        <meta property="og:description" content="Calculate tiles, adhesive, and grout instantly. Free professional tool for UK tilers." />
        ...
        {showQuoteGenerator && results && (
          <QuoteGenerator
            calculationResults={{
              ...
              summary: `${results.surfaceType === 'wall' ? 'Wall' : 'Floor'} tiling ${results.area}m² - ${results.pattern === 'grid' ? 'Grid layout' : results.pattern === 'diagonal' ? 'Diagonal pattern' : 'Herringbone pattern'} (${wasteFactor}% waste factor included)`
            }}
