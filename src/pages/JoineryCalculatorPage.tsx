  ...
  return (
    <>
      <Helmet>
        ...
        />
        <meta name="keywords" content="joinery calculator, wood cost calculator, carpenter calculator, UK joiner tools, timber cost calculator, bespoke joinery pricing, labour calculator, fitted kitchen cost, custom furniture pricing, staircase cost" />
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-blue-800">
                            {result.totalVolume}m³ of {result.woodType} (waste: {result.wastePercentage}%) + {result.estimatedHours} hours labour at £{result.hourlyRate}/hr with {result.finish} finish = £{result.totalCost} materials + labour. Recommended quote: £{result.recommendedPrice} (includes 15% contingency).
                          </p>
                        </div>
                      </div>
                    </div>
