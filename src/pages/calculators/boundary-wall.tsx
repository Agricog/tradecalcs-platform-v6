...
const usecaseData = {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: 'Budget £150-250 per linear metre for a 1.8m boundary wall including materials, labour, and foundations. A 15m wall costs approximately £2,500-4,000 total. Add 20% for piers and coping. Complex sites or access issues increase costs.'
    },
    {
      q: 'What foundation depth for a boundary wall?',
      a: 'Minimum 300mm deep and 3× the wall width for walls up to 1.5m. Walls over 1.5m or in clay soil need 450mm+ depth. Foundations should be below frost level and on undisturbed ground. Always consult Building Control for taller walls.'
    },
    {
    ...
    '@graph': [
      ...
      },
      {
        ...
        step: [
          ...
          { '@type': 'HowToStep', position: 4, name: 'Calculate Base Bricks', text: 'Use calculator with length × height to get base brick quantity.' },
            ...
            <div className="lg:col-span-2">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                ...
                <div className="prose prose-sm max-w-none text-gray-700">
                  <p className="mb-4">Boundary walls are a permanent way to define property boundaries. Unlike fences, they require proper foundations and often need piers for structural support.</p>

                  <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">Pier Calculations for Boundary Walls</h3>
                  <p className="mb-4">Walls over 1m height need structural support from piers:</p>
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4 my-4">
                    ...
                    <p className="text-green-800 text-sm">
                      Wall bricks: 15m × 1.8m × 60 = 1,620 bricks<br />
                      Pier calculation: 15m ÷ 3m = 5 intervals + 1 = 6 piers<br />
                      Pier bricks: 6 piers × 1.8m × 56 = 605 bricks<br />
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-green-50 rounded-lg p-4">
                    <h3 className="font-semibold text-green-900 mb-2">✓ No Permission Needed</h3>
                    <ul className="text-sm text-green-800 space-y-1">
                      <li>• Rear boundary wall up to 2m</li>
                      <li>• Front wall up to 1m (not adjacent to highway)</li>
                      <li>• Internal garden walls</li>
                      <li>• Like-for-like replacement</li>
                    </ul>
                  </div>
                  <div className="bg-red-50 rounded-lg p-4">
                    <h3 className="font-semibold text-red-900 mb-2">✗ Permission Required</h3>
                    <ul className="text-sm text-red-800 space-y-1">
                      <li>• Any wall over 2m height</li>
                      <li>• Front wall over 1m adjacent to highway</li>
                      <li>• Conservation area (any wall)</li>
                      <li>• Listed building curtilage</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between p-2 bg-green-50 rounded"><span className="text-green-800">Rear boundary ≤2m</span><span className="font-medium text-green-700">No permission</span></div>
                  <div className="flex justify-between p-2 bg-green-50 rounded"><span className="text-green-800">Front boundary ≤1m</span><span className="font-medium text-green-700">No permission</span></div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                <h3 className="font-semibold text-blue-900 mb-2">📋 Party Wall Notice</h3>
