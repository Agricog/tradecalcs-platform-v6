          ...
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg p-6 mb-8">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div>
                ...
                <p className="text-purple-100">Get quotes from vetted, local contractors for your heat pump installation</p>
              </div>
              <a 
                href="#get-quotes" 
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8" id="get-quotes">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-700">
                Looking for a qualified electrician for your heat pump installation? Tell us about your project and we'll connect you with vetted contractors in your area. Free, no obligation quotes.
              </p>
            </div>
