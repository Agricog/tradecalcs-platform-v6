...
export default function Tools() {
  const tools = [
    { id: 'cable', name: 'Cable Size Calculator', description: 'BS 7671 compliant electrical cable sizing', icon: Calculator, color: 'from-purple-600 to-blue-600', link: '/cable-calculator' },
    { id: 'voltage', name: 'Voltage Drop Calculator', description: 'Calculate voltage drop for any circuit', icon: Zap, color: 'from-blue-600 to-purple-600', link: '/voltage-drop' },
    { id: 'bsp', name: 'BSP Thread Finder', description: 'Identify British Standard Pipe threads', icon: Wrench, color: 'from-red-600 to-orange-600', link: '/bsp-thread' },
    { id: 'roof', name: 'Roofing Calculator', description: 'Calculate roofing materials with pitch', icon: Home, color: 'from-green-600 to-emerald-600', link: '/roofing-insurance' }
  ]
