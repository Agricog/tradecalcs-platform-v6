  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Free plaster calculator for UK plasterers. Calculate coverage, material quantities, and drying times instantly. Professional tool with waste factors." 
        />
        <meta name="keywords" content="plaster calculator, plastering calculator, UK plasterer tools, plaster coverage calculator, skim coat calculator, gypsum plaster calculator" />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Plaster Calculator UK | Coverage & Material Estimator for Plasterers" />
        <meta property="og:description" content="Calculate plaster coverage and materials instantly. Free professional tool for UK plasterers." />
        ...
        <meta name="twitter:description" content="Free plaster calculator. Calculate coverage, bags needed, and drying times." />
