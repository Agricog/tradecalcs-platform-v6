import { Zap, Shield, Smartphone, DollarSign, Lightbulb, CheckCircle2, ArrowRight, Package } from 'lucide-react'
      ...
      <section id="calculators" className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <a href="/voltage-drop" className="bg-white border-2 border-gray-200 rounded-lg p-6 hover:shadow-lg transition">
            ...
            <a href="/roofing-insurance" className="bg-white border-2 border-gray-200 rounded-lg p-6 hover:shadow-lg transition">
            ...
            <a href="/concrete-calculator" className="bg-white border-2 border-gray-200 rounded-lg p-6 hover:shadow-lg transition">
              <div className="w-12 h-12 bg-green-600 rounded-lg flex items-center justify-center text-white mb-4">
