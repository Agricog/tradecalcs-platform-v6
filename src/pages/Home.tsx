import { Zap, Shield, Smartphone, PoundSterling, Lightbulb, CheckCircle2, ArrowRight, Package, Palette, Hammer, Home as HomeIcon, Droplet, Calculator, Droplets, TruckIcon, Phone, Mail, MessageSquare } from 'lucide-react'
...
export default function Home() {
  useEffect(() => {
    ...
    if (metaDescription) metaDescription.setAttribute('content', 'Free professional trade calculators for electricians, plumbers, builders, painters & more. BS 7671 compliant, mobile-ready. Cable sizing, voltage drop, concrete, paint & 15+ more calculators.')
    
    // SEO Meta Keywords
    const metaKeywords = document.querySelector('meta[name="keywords"]')
    if (metaKeywords) metaKeywords.setAttribute('content', 'trade calculators, electrician calculator, plumber calculator, builder calculator, cable sizing, voltage drop, BS 7671, professional calculators, UK trades')
    ...
    if (canonicalLink) canonicalLink.setAttribute('href', 'https://tradecalcs.co.uk')
      ...
      '@graph': [
        {
          ...
          'sameAs': ['https://twitter.com/tradecalcs', 'https://facebook.com/tradecalcs', 'https://linkedin.com/company/tradecalcs'],
          'contactPoint': {
            '@type': 'ContactPoint',
          ...
          'mainEntity': [
            {
              ...
              'acceptedAnswer': {
                '@type': 'Answer',
                'text': 'We offer 16+ professional calculators for electricians, plumbers, builders, painters, plasterers, joiners, bricklayers, tilers, roofers, scaffolders and more. All calculators are free to use and BS 7671 compliant where applicable.'
              }
            },
            {
              '@type': 'Question',
      ...
      <section id="calculators" className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-xl p-8 mb-12 shadow-xl">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-6">
                <Link to="/paint-calculator" className="bg-white text-purple-600 px-6 py-3 rounded-lg font-bold hover:bg-gray-100 transition">
                  Painter Calculator
                </Link>
                <Link to="/cable-sizing-calculator" className="bg-white text-purple-600 px-6 py-3 rounded-lg font-bold hover:bg-gray-100 transition">
                  Electrician Calculator
                </Link>
                <Link to="/joinery-calculator" className="bg-white text-purple-600 px-6 py-3 rounded-lg font-bold hover:bg-gray-100 transition">
                  Joinery Calculator
                </Link>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            {/* Cable Sizing */}
            <Link to="/cable-sizing-calculator" className="bg-white border-2 border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition">
              <div className="p-6">
                ...
                <div className="text-blue-600 font-semibold flex items-center gap-2 hover:gap-3 transition">
            ...
            {/* Voltage Drop */}
            <Link to="/voltage-drop-calculator" className="bg-white border-2 border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition">
              <div className="p-6">
                ...
                <div className="text-cyan-600 font-semibold flex items-center gap-2 hover:gap-3 transition">
                  Use Calculator <ArrowRight className="w-4 h-4" />
                </div>
              </div>
            </Link>
            ...
            {/* BSP Thread */}
            <Link to="/bsp-thread-calculator" className="bg-white border-2 border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition">
              <div className="p-6">
                ...
                <div className="text-orange-600 font-semibold flex items-center gap-2 hover:gap-3 transition">
                  Use Calculator <ArrowRight className="w-4 h-4" />
                </div>
              </div>
            </Link>
            ...
            {/* Roofing Insurance */}
            <Link to="/roofing-insurance-calculator" className="bg-white border-2 border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition">
              <div className="p-6">
            ...
            {/* Concrete */}
            <Link to="/concrete-calculator" className="bg-white border-2 border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition">
              <div className="p-6">
            ...
            {/* Drainage Calculator - NEW */}
            <Link to="/drainage-calculator" className="bg-white border-2 border-purple-300 rounded-lg overflow-hidden hover:shadow-lg transition relative">
              <div className="absolute top-4 right-4 bg-purple-600 text-white px-3 py-1 rounded-full text-xs font-bold">NEW</div>
              <div className="p-6">
                <div className="text-xs font-bold text-purple-600 mb-3 uppercase tracking-wider">For Drainage Contractors</div>
                <div className="w-12 h-12 bg-purple-600 rounded-lg flex items-center justify-center text-white mb-4">
                  <Droplets className="w-6 h-6" />
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-2">Underground Drainage Calculator</h3>
                <p className="text-gray-600 text-sm mb-4">Calculate pipe bedding, spoil removal, and backfill requirements instantly</p>
            ...
            {/* Plasterer */}
            <Link to="/plasterer-calculator" className="bg-white border-2 border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition">
              <div className="p-6">
            ...
            {/* Joinery */}
            <Link to="/joinery-calculator" className="bg-white border-2 border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition">
              <div className="p-6">
            ...
            {/* Brick Block */}
            <Link to="/brick-block-calculator" className="bg-white border-2 border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition">
              <div className="p-6">
            ...
            {/* Tiling */}
            <Link to="/tiling-calculator" className="bg-white border-2 border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition">
              <div className="p-6">
            ...
            {/* Paint */}
            <Link to="/paint-calculator" className="bg-white border-2 border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition">
              <div className="p-6">
            ...
            {/* CIS Calculator */}
            <Link to="/calculators/cis-calculator" className="bg-white border-2 border-purple-300 rounded-lg overflow-hidden hover:shadow-lg transition relative">
              <div className="absolute top-4 right-4 bg-purple-600 text-white px-3 py-1 rounded-full text-xs font-bold">NEW</div>
              <div className="p-6">
            ...
            {/* STGO Calculator */}
            <Link to="/stgo-calculator" className="bg-white border-2 border-orange-300 rounded-lg overflow-hidden hover:shadow-lg transition relative">
            ...
            {/* Scaffold Calculator */}
            <Link to="/scaffold-calculator" className="bg-white border-2 border-blue-300 rounded-lg overflow-hidden hover:shadow-lg transition relative">
            ...
            <Link to="/insulation-calculator" className="bg-white border-2 border-green-300 rounded-lg overflow-hidden hover:shadow-lg transition relative">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <button onClick={() => document.getElementById('calculators')?.scrollIntoView({ behavior: 'smooth' })} className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-8 py-3 rounded-lg font-bold hover:shadow-lg inline-flex items-center gap-2">
            ...
            <div className="bg-gradient-to-br from-purple-600 to-blue-600 text-white rounded-lg p-8">
              ...
              <p className="mb-6 opacity-95">
                Join professional tradespeople who are already saving time and reducing errors with TradeCalcs.
              </p>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-blue-50 to-purple-50 border-y-2 border-purple-200">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-white rounded-lg p-6 border-2 border-purple-200 text-center hover:shadow-lg transition">
              <div className="w-14 h-14 bg-purple-100 rounded-lg flex items-center justify-center text-2xl mx-auto mb-4">🛠️</div>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="flex items-center gap-4 p-4 bg-purple-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-purple-600">Same number, instant reply</p>
                  </div>
                </div>
      ...
      <section id="custom" className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 border-2 border-purple-200 rounded-lg p-8 text-center">
            ...
            <a href="https://app.smartsuite.com/form/sba974gi/Zx9ZVTVrwE" target="_blank" rel="noopener noreferrer" className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-3 rounded-lg font-bold inline-flex items-center gap-2 transition">
